    ...
    <div style={{ background: 'var(--bg)' }}>
      ...
      <div className="p-2 flex flex-col gap-3 lg:grid lg:gap-2"
        ...
        <div className="min-w-0 w-full">
          <Scoreboard onTeamAWin={() => handleWin('A')} onTeamBWin={() => handleWin('B')} stackedLayout avatarASrc="/avatar-silhouette.svg" avatarBSrc="/avatar-silhouette.svg" avatarBPosition="center" hideGameType hideGameNumber hideBreakIndicator avatarSize={224} />
        </div>
        <div className="min-w-0 w-full">
          <GameDescription />
        </div>
