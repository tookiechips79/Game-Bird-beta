  ...
  return (
    <div className="flex flex-col" style={{ minHeight: '100dvh', position: 'relative' }}>
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-3 flex flex-col gap-3" style={{ paddingTop: isAdmin ? (adminOpen ? headerH + 160 : headerH + 48) : 16 }}>
        ...
        <PlayerBank />
        <Scoreboard onTeamAWin={() => handleWin('A')} onTeamBWin={() => handleWin('B')} hideAdminControls avatarASrc="/james.jpeg" avatarBSrc="/ross.jpeg" avatarBPosition="0% center" hideBreakIndicator hideGameType avatarSize={224} />
        <BettingQueue />
